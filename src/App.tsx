...
const knowledge = [
    ...
    {
        q: 'What my goals?',
        a: 'I don\'t see AI as just another technology trend. My long-term goal is to build production AI systems that solve real business problems, and I actively invest my personal time in learning and building AI products outside of work.'
    },
    {
